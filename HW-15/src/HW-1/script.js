...
// //max and min values
export const maxPrice = Math.max(priceOfDress, priceOfJacket, priceOfSkirt);
export const minPrice = Math.min(priceOfDress, priceOfJacket, priceOfSkirt);
...
// //rounded to hundred
export const roundedToHundred = Math.round((Math.ceil(sumOfProducts))/100)*100;
